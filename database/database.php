<?php
  ...
  if ($con->query($sql) === true) {
    $sql = "CREATE TABLE IF NOT EXISTS `Music4U`.`users` ( `id_user` INT NOT NULL AUTO_INCREMENT , `nombre` VARCHAR(20) NOT NULL , `user` VARCHAR(20) NOT NULL , `pass` INT NOT NULL , `num_canciones` INT NULL DEFAULT NULL , `fec_cre` DATE NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`id_user`), UNIQUE (`user`)) ENGINE = InnoDB;";
    if ($con->query($sql) != true) {
